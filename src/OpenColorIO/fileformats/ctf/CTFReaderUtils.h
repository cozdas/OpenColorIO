...
static constexpr char TAG_DYN_PROP_HUECURVE[] = "HUE_CURVE";
...
static constexpr char TAG_HUE_CURVE[] = "GradingHueCurve";
static constexpr char TAG_HUE_CURVE_HUE_HUE[] = "HueHue";
static constexpr char TAG_HUE_CURVE_HUE_SAT[] = "HueSat";
static constexpr char TAG_HUE_CURVE_HUE_LUM[] = "HueLum";
static constexpr char TAG_HUE_CURVE_LUM_SAT[] = "LumSat";
static constexpr char TAG_HUE_CURVE_SAT_SAT[] = "SatSat";
static constexpr char TAG_HUE_CURVE_LUM_LUM[] = "LumLum";
static constexpr char TAG_HUE_CURVE_SAT_LUM[] = "SatLum";
static constexpr char TAG_HUE_CURVE_HUE_FX[] = "HueFx";
...
static constexpr char ATTR_RGB_TO_HSY[] = "hsyTransform";
